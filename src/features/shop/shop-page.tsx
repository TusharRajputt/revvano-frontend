      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 pb-20">
        ...
        {hasFilters && (
          <div className="flex flex-wrap gap-2 mb-6">
            ...
            {category && (
              <FilterChip label={categories.find((c) => c.slug === category)?.name || category} onRemove={() => updateFilter('category', '')} />
            )}
            {search && (
                  ...
                  <div className="space-y-2">
                    {categories.map((c) => (
                      <button
                        ...
                        className={cn(
                          'block w-full text-left py-2 text-sm transition-colors',
                          category === c.slug ? 'text-accent font-semibold' : 'hover:text-accent',
                        )}
                      >
                        {c.name}
                      </button>
