...
import { formatPrice, calculateDiscount, getProductPricing } from '@/utils/format';
...
export function ProductDetailPage() {
  ...
  const { current: currentPrice, original: originalPrice } = getProductPricing(product);
  ...
  return (
    <>
          ...
          <div className="lg:py-4">
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-2">
                ...
                <button onClick={() => setSizeGuideOpen(true)} className="text-xs underline text-muted-foreground hover:text-accent">Size Guide</button>
              </div>
      ...
      <SizeGuideModal open={sizeGuideOpen} onOpenChange={setSizeGuideOpen} productSizeGuide={product.sizeGuide} />
    </>
  );
}
