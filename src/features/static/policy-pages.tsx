  ...
  return (
    <PolicyPage
      ...
      sections={[
        ...
        { heading: 'Contact Us', body: `To initiate a return or ask about a refund, contact Revvano at ${BRAND.email} or ${BRAND.phone}. Our registered address is ${BRAND.address}.` },
      ]}
    />
  );
}
  ...
  return (
    <PolicyPage
      ...
      sections={[
        ...
        { heading: 'Cancellations by Revvano', body: 'We reserve the right to cancel an order due to stock unavailability, pricing errors, or suspected fraudulent activity. If we cancel your order, you will be notified by email and refunded in full within 5-7 business days.' },
        ...
        { heading: 'Contact Us', body: `To cancel an order or ask about a cancellation, contact Revvano at ${BRAND.email} or ${BRAND.phone}. Our registered address is ${BRAND.address}.` },
      ]}
    />
  );
}
...
export function TermsPage() {
  return (
    <PolicyPage
      ...
      sections={[
        { heading: 'About Us', body: `Revvano ("we", "us", "our") is an online fashion and apparel retailer operating this website, stylized as "रेvvano" in our logo and branding. For any questions regarding these terms, you can reach us at ${BRAND.email}, ${BRAND.phone}, or write to us at ${BRAND.address}.` },
